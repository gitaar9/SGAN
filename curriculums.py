...
SHAPENETSHIPS_SYM_LOSS_HIERARCHICAL_V3 = {
    0: {'batch_size': 30, 'num_steps': 30, 'img_size': 32, 'batch_split': 1, 'gen_lr': 4e-5, 'disc_lr': 4e-4},
    int(10e3): {'batch_size': 30, 'num_steps': 30, 'img_size': 32, 'batch_split': 1, 'gen_lr': 2e-5, 'disc_lr': 2e-4},
...
SHAPENETCARS_SYM_LOSS_HIGH_BATCH_SIZE = {
    ...
    int(30e3): {'batch_size': 32, 'num_steps': 29, 'img_size': 64, 'batch_split': 4, 'gen_lr': 2e-5, 'disc_lr': 2e-4},
    int(75e3): {'batch_size': 32, 'num_steps': 29, 'img_size': 128, 'batch_split': 16, 'gen_lr': 10e-6, 'disc_lr': 10e-5},
    int(200e3): {},
...
SHAPENETCARS_NO_MIRROR_HIGH_BATCH_SIZE = {
    ...
    int(75e3): {'batch_size': 16, 'num_steps': 29, 'img_size': 128, 'batch_split': 8, 'gen_lr': 10e-6, 'disc_lr': 10e-5},
    int(200e3): {},
